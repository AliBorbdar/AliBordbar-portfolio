...
import Thumbnail02 from "@/public/images/tutorial-02.png";

export default function Tutorials() {
  const items = [
    {
      title: "Junior Frontend Developer – Coding Front",
      link: "#0",
      image: Thumbnail01,
    },
    {
      title: "Hero Frontend Developer of the World – Ali Bordbar",
      link: "#0",
      image: Thumbnail02,
    },
