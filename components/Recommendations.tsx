  ...
  const items = [
    {
      ...
      link: "#0",
      content:
        "Ali’s code runs smoother than a Tesla autopilot. If he ever decides to write software for Mars colonization, I’ll put SpaceX on standby to deploy him.",
    },
    {
      name: "Jason Hung",
      role: "Co-founder, TechLabs",
      image: TestimonialImg02,
      link: "#0",
      content:
        "When we hired Ali as our Junior Frontend Developer, I thought ‘okay, another coder.’ Turns out his code is cleaner than the lab’s entire coffee machine system!",
    },
    {
      name: "Pavel Durov",
      ...
      link: "#0",
      content:
        "Even Telegram’s paper plane couldn’t fly faster than Ali’s ideas. His front‑end work feels like encrypted beauty in motion.",
    },
    {
      name: "Larry Page",
      ...
      link: "#0",
      content:
        "Ali changed the definition of search efficiency — because when you Google ‘best Junior Frontend Developer in the world,’ you just find Ali.",
    },
  ];
